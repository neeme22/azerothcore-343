...
function(CheckApplicationsBuildList)
  ...
  foreach(APPLICATION_BUILD_NAME ${APPLICATIONS_BUILD_LIST})
    ...
    # El cliente 3.4.3 entra por el bnetserver; el authserver 3.3.5 no se usa y no compila con la lista de reinos de
    # TrinityCore (Realm::Addresses), así que queda desactivado salvo que se pida con -DAPP_AUTHSERVER=enabled
    if(APPLICATION_BUILD_NAME STREQUAL "authserver" AND ${APPLICATION_BUILD_VARIABLE} STREQUAL "default")
    ...
    if(${APPLICATION_BUILD_VARIABLE} MATCHES "enabled")
      ...
      elseif(${APPLICATION_BUILD_NAME} MATCHES "bnetserver")
        set (BUILD_APPLICATION_BNETSERVER 1 PARENT_SCOPE)
