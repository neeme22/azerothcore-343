...
#ifndef BNET_SocketMgr_h
#define BNET_SocketMgr_h

#include "BnetAsyncAcceptor.h"
#include "Errors.h"
#include "BnetNetworkThread.h"
#include <boost/asio/ip/tcp.hpp>
#include <memory>

// pila de red de TrinityCore para bnetserver/Http (la de AC sigue en SocketMgr.h)
namespace Bnet
{
...
using Bnet::SocketMgr;

#endif // BNET_SocketMgr_h
