...
#ifndef BNET_NetworkThread_h
#define BNET_NetworkThread_h
...
// pila de red de TrinityCore para bnetserver/Http (la de AC sigue en NetworkThread.h)
namespace Bnet
{
...
using Bnet::NetworkThread;

#endif // BNET_NetworkThread_h
