...
#ifndef BNET_ASYNCACCEPT_H
#define BNET_ASYNCACCEPT_H
...
// pila de red de TrinityCore para bnetserver/Http (la de AC sigue en AsyncAcceptor.h)
namespace Bnet
{
...
using Bnet::AsyncAcceptor;

#endif /* BNET_ASYNCACCEPT_H */
