...
void AC_PROTO_API protobuf_AddDesc_club_5fban_2eproto();
...
class AC_PROTO_API AddBanOptions : public ::google::protobuf::Message {
 public:
  AddBanOptions();
 ...
 private:
  ...
  ::std::string* reason_;
  friend void AC_PROTO_API protobuf_AddDesc_club_5fban_2eproto();
...
class AC_PROTO_API ClubBan : public ::google::protobuf::Message {
 public:
  ClubBan();
  virtual ~ClubBan();
