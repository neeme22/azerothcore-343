...
void AC_PROTO_API protobuf_AddDesc_semantic_5fversion_2eproto();
...
class AC_PROTO_API SemanticVersion : public ::google::protobuf::Message {
 public:
  SemanticVersion();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_semantic_5fversion_2eproto();
