...
void AC_PROTO_API protobuf_AddDesc_club_5fmembership_5flistener_2eproto();
...
class AC_PROTO_API ClubAddedNotification : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5fmembership_5flistener_2eproto();
...
class AC_PROTO_API ClubRemovedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ReceivedInvitationAddedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ReceivedInvitationRemovedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API SharedSettingsChangedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API StreamMentionAddedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API StreamMentionRemovedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API StreamMentionAdvanceViewTimeNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubMembershipListener : public ServiceBase
{
 public:
