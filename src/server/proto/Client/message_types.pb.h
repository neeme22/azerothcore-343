...
void AC_PROTO_API protobuf_AddDesc_message_5ftypes_2eproto();
...
AC_PROTO_API bool TypingIndicator_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* TypingIndicator_descriptor();
...
class AC_PROTO_API MessageId : public ::google::protobuf::Message {
 public:
  MessageId();
  virtual ~MessageId();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_message_5ftypes_2eproto();
