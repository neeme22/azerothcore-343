...
void AC_PROTO_API protobuf_AddDesc_club_5frange_5fset_2eproto();
...
class AC_PROTO_API ClubTypeRangeSet : public ::google::protobuf::Message {
 public:
  ClubTypeRangeSet();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5frange_5fset_2eproto();
...
class AC_PROTO_API ClubMemberRangeSet : public ::google::protobuf::Message {
 public:
  ClubMemberRangeSet();
...
class AC_PROTO_API ClubStreamRangeSet : public ::google::protobuf::Message {
 public:
  ClubStreamRangeSet();
...
class AC_PROTO_API ClubInvitationRangeSet : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubSuggestionRangeSet : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubTicketRangeSet : public ::google::protobuf::Message {
 public:
  ClubTicketRangeSet();
...
class AC_PROTO_API ClubBanRangeSet : public ::google::protobuf::Message {
 public:
  ClubBanRangeSet();
