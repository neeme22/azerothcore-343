...
void AC_PROTO_API protobuf_AddDesc_club_5ftag_2eproto();
...
AC_PROTO_API bool TagAction_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* TagAction_descriptor();
...
AC_PROTO_API bool TagType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* TagType_descriptor();
...
class AC_PROTO_API TagOptions : public ::google::protobuf::Message {
 public:
  TagOptions();
  virtual ~TagOptions();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5ftag_2eproto();
...
class AC_PROTO_API TagIdentifier : public ::google::protobuf::Message {
 public:
  TagIdentifier();
...
class AC_PROTO_API LocalizedTag : public ::google::protobuf::Message {
 public:
  LocalizedTag();
