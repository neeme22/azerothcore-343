...
void AC_PROTO_API protobuf_AddDesc_presence_5ftypes_2eproto();
...
AC_PROTO_API bool FieldOperation_OperationType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* FieldOperation_OperationType_descriptor();
...
class AC_PROTO_API RichPresenceLocalizationKey : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_presence_5ftypes_2eproto();
...
class AC_PROTO_API FieldKey : public ::google::protobuf::Message {
 public:
  FieldKey();
  virtual ~FieldKey();
...
class AC_PROTO_API Field : public ::google::protobuf::Message {
 public:
  Field();
  virtual ~Field();
...
class AC_PROTO_API FieldOperation : public ::google::protobuf::Message {
 public:
  FieldOperation();
...
class AC_PROTO_API PresenceState : public ::google::protobuf::Message {
 public:
  PresenceState();
