...
void AC_PROTO_API protobuf_AddDesc_rpc_5fconfig_2eproto();
...
class AC_PROTO_API RPCMethodConfig : public ::google::protobuf::Message {
 public:
  RPCMethodConfig();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_rpc_5fconfig_2eproto();
...
class AC_PROTO_API RPCMeterConfig : public ::google::protobuf::Message {
 public:
  RPCMeterConfig();
