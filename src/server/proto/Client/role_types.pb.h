...
void AC_PROTO_API protobuf_AddDesc_role_5ftypes_2eproto();
...
class AC_PROTO_API Role : public ::google::protobuf::Message {
 public:
  Role();
  virtual ~Role();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_role_5ftypes_2eproto();
...
class AC_PROTO_API RoleState : public ::google::protobuf::Message {
 public:
  RoleState();
  virtual ~RoleState();
