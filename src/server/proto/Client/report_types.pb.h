...
void AC_PROTO_API protobuf_AddDesc_report_5ftypes_2eproto();
...
AC_PROTO_API bool SpamReport_SpamSource_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* SpamReport_SpamSource_descriptor();
...
class AC_PROTO_API ReportType : public ::google::protobuf::Message {
 public:
  ReportType();
  virtual ~ReportType();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_report_5ftypes_2eproto();
...
class AC_PROTO_API CustomReport : public ::google::protobuf::Message {
 public:
  CustomReport();
...
class AC_PROTO_API SpamReport : public ::google::protobuf::Message {
 public:
  SpamReport();
  virtual ~SpamReport();
...
class AC_PROTO_API HarassmentReport : public ::google::protobuf::Message {
 public:
  HarassmentReport();
...
class AC_PROTO_API RealLifeThreatReport : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API InappropriateBattleTagReport : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API HackingReport : public ::google::protobuf::Message {
 public:
  HackingReport();
...
class AC_PROTO_API BottingReport : public ::google::protobuf::Message {
 public:
  BottingReport();
...
class AC_PROTO_API Report : public ::google::protobuf::Message {
 public:
  Report();
  virtual ~Report();
