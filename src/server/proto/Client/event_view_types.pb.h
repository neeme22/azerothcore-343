...
void AC_PROTO_API protobuf_AddDesc_event_5fview_5ftypes_2eproto();
...
AC_PROTO_API bool EventOrder_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* EventOrder_descriptor();
...
class AC_PROTO_API GetEventOptions : public ::google::protobuf::Message {
 public:
  GetEventOptions();
 ...
 private:
  ...
  int order_;
  friend void AC_PROTO_API protobuf_AddDesc_event_5fview_5ftypes_2eproto();
...
class AC_PROTO_API ViewMarker : public ::google::protobuf::Message {
 public:
  ViewMarker();
  virtual ~ViewMarker();
