...
void AC_PROTO_API protobuf_AddDesc_club_5fmember_5fid_2eproto();
...
class AC_PROTO_API MemberId : public ::google::protobuf::Message {
 public:
  MemberId();
  virtual ~MemberId();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5fmember_5fid_2eproto();
