...
void AC_PROTO_API protobuf_AddDesc_entity_5ftypes_2eproto();
...
class AC_PROTO_API EntityId : public ::google::protobuf::Message {
 public:
  EntityId();
  virtual ~EntityId();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_entity_5ftypes_2eproto();
