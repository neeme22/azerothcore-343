...
void AC_PROTO_API protobuf_AddDesc_presence_5fservice_2eproto();
...
class AC_PROTO_API SubscribeRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_presence_5fservice_2eproto();
...
class AC_PROTO_API UpdateRequest : public ::google::protobuf::Message {
 public:
  UpdateRequest();
...
class AC_PROTO_API QueryRequest : public ::google::protobuf::Message {
 public:
  QueryRequest();
...
class AC_PROTO_API QueryResponse : public ::google::protobuf::Message {
 public:
  QueryResponse();
...
class AC_PROTO_API BatchSubscribeRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API SubscribeResult : public ::google::protobuf::Message {
 public:
  SubscribeResult();
...
class AC_PROTO_API BatchSubscribeResponse : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API BatchUnsubscribeRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API PresenceService : public ServiceBase
{
 public:
