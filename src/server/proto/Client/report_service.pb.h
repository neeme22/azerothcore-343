...
void AC_PROTO_API protobuf_AddDesc_report_5fservice_2eproto();
...
class AC_PROTO_API SendReportRequest : public ::google::protobuf::Message {
 public:
  SendReportRequest();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_report_5fservice_2eproto();
...
class AC_PROTO_API SubmitReportRequest : public ::google::protobuf::Message {
 public:
  SubmitReportRequest();
...
class AC_PROTO_API ReportService : public ServiceBase
{
 public:
