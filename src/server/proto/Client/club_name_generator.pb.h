...
void AC_PROTO_API protobuf_AddDesc_club_5fname_5fgenerator_2eproto();
...
class AC_PROTO_API NameGeneratorConfig : public ::google::protobuf::Message {
 public:
  NameGeneratorConfig();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5fname_5fgenerator_2eproto();
...
class AC_PROTO_API NameGeneratorScorecard : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API NameGenerator : public ::google::protobuf::Message {
 public:
  NameGenerator();
...
class AC_PROTO_API NameGeneratorReplacement : public ::google::protobuf::Message {
 public:
