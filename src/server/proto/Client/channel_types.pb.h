...
void AC_PROTO_API protobuf_AddDesc_channel_5ftypes_2eproto();
...
AC_PROTO_API bool ChannelState_PrivacyLevel_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* ChannelState_PrivacyLevel_descriptor();
...
class AC_PROTO_API Message : public ::google::protobuf::Message {
 public:
  Message();
  virtual ~Message();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_channel_5ftypes_2eproto();
...
class AC_PROTO_API ListChannelsOptions : public ::google::protobuf::Message {
 public:
  ListChannelsOptions();
...
class AC_PROTO_API ChannelDescription : public ::google::protobuf::Message {
 public:
  ChannelDescription();
...
class AC_PROTO_API ChannelInfo : public ::google::protobuf::Message {
 public:
  ChannelInfo();
  virtual ~ChannelInfo();
...
class AC_PROTO_API ChannelState : public ::google::protobuf::Message {
 public:
  ChannelState();
...
class AC_PROTO_API MemberAccountInfo : public ::google::protobuf::Message {
 public:
  MemberAccountInfo();
...
class AC_PROTO_API MemberState : public ::google::protobuf::Message {
 public:
  MemberState();
  virtual ~MemberState();
...
class AC_PROTO_API SubscriberId : public ::google::protobuf::Message {
 public:
  SubscriberId();
