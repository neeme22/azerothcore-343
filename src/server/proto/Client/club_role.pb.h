...
void AC_PROTO_API protobuf_AddDesc_club_5frole_2eproto();
...
class AC_PROTO_API ClubPrivilegeSet : public ::google::protobuf::Message {
 public:
  ClubPrivilegeSet();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5frole_2eproto();
...
class AC_PROTO_API ClubRole : public ::google::protobuf::Message {
 public:
  ClubRole();
  virtual ~ClubRole();
...
class AC_PROTO_API ClubRoleSet : public ::google::protobuf::Message {
 public:
  ClubRoleSet();
  virtual ~ClubRoleSet();
