...
void AC_PROTO_API protobuf_AddDesc_resource_5fservice_2eproto();
...
class AC_PROTO_API ContentHandleRequest : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_resource_5fservice_2eproto();
...
class AC_PROTO_API GetTitleIconsRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API GetTitleIconsResponse : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ResourcesService : public ServiceBase
{
 public:
