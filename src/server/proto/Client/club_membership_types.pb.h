...
void AC_PROTO_API protobuf_AddDesc_club_5fmembership_5ftypes_2eproto();
...
class AC_PROTO_API ClubMembershipFilter : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5fmembership_5ftypes_2eproto();
...
class AC_PROTO_API ClubMembershipSubscribeOptions : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubMembershipGetStateOptions : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubMembershipDescription : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubMembershipState : public ::google::protobuf::Message {
 public:
  ClubMembershipState();
...
class AC_PROTO_API ClubPosition : public ::google::protobuf::Message {
 public:
  ClubPosition();
...
class AC_PROTO_API ClubSharedSettings : public ::google::protobuf::Message {
 public:
  ClubSharedSettings();
...
class AC_PROTO_API ClubSharedSettingsOptions : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubSharedSettingsAssignment : public ::google::protobuf::Message {
 public:
