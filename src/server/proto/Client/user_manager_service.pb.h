...
void AC_PROTO_API protobuf_AddDesc_user_5fmanager_5fservice_2eproto();
...
class AC_PROTO_API SubscribeRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_user_5fmanager_5fservice_2eproto();
...
class AC_PROTO_API SubscribeResponse : public ::google::protobuf::Message {
 public:
  SubscribeResponse();
...
class AC_PROTO_API AddRecentPlayersRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClearRecentPlayersRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API BlockPlayerRequest : public ::google::protobuf::Message {
 public:
  BlockPlayerRequest();
...
class AC_PROTO_API UnblockPlayerRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API BlockedPlayerAddedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API BlockedPlayerRemovedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RecentPlayersAddedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RecentPlayersRemovedNotification : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API UserManagerService : public ServiceBase
{
 public:
...
class AC_PROTO_API UserManagerListener : public ServiceBase
{
 public:
