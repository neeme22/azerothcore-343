...
void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2frouting_2eproto();
...
AC_PROTO_API bool ClientIdentityRoutingType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* ClientIdentityRoutingType_descriptor();
