...
void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2ffield_5foptions_2eproto();
...
AC_PROTO_API bool EntityIdRestriction_Kind_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* EntityIdRestriction_Kind_descriptor();
...
AC_PROTO_API bool LogOption_IsValid(int value);
const LogOption LogOption_MIN = HIDDEN;
const LogOption LogOption_MAX = HEX;
const int LogOption_ARRAYSIZE = LogOption_MAX + 1;

AC_PROTO_API const ::google::protobuf::EnumDescriptor* LogOption_descriptor();
...
class AC_PROTO_API BGSFieldOptions : public ::google::protobuf::Message {
 public:
  BGSFieldOptions();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2ffield_5foptions_2eproto();
...
class AC_PROTO_API FieldRestriction : public ::google::protobuf::Message {
 public:
  FieldRestriction();
...
class AC_PROTO_API RepeatedFieldRestriction : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API SignedFieldRestriction : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API UnsignedFieldRestriction : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API FloatFieldRestriction : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API StringFieldRestriction : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API EntityIdRestriction : public ::google::protobuf::Message {
 public:
  EntityIdRestriction();
...
class AC_PROTO_API MessageFieldRestriction : public ::google::protobuf::Message {
 public:
...
AC_PROTO_API extern ::google::protobuf::internal::ExtensionIdentifier< ::google::protobuf::FieldOptions,
