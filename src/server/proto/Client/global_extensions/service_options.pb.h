...
void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2fservice_5foptions_2eproto();
...
AC_PROTO_API bool BGSServiceOptions_ServiceType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* BGSServiceOptions_ServiceType_descriptor();
...
class AC_PROTO_API BGSServiceOptions : public ::google::protobuf::Message {
 public:
  BGSServiceOptions();
 ...
 private:
  ...
  bool is_global_;
  friend void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2fservice_5foptions_2eproto();
...
class AC_PROTO_API SDKServiceOptions : public ::google::protobuf::Message {
 public:
  SDKServiceOptions();
...
AC_PROTO_API extern ::google::protobuf::internal::ExtensionIdentifier< ::google::protobuf::ServiceOptions,
