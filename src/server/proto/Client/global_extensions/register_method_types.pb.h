...
void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2fregister_5fmethod_5ftypes_2eproto();
...
AC_PROTO_API bool ClientRegisterMethodType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* ClientRegisterMethodType_descriptor();
