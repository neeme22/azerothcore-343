...
void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2frange_2eproto();
...
class AC_PROTO_API UnsignedIntRange : public ::google::protobuf::Message {
 public:
  UnsignedIntRange();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_global_5fextensions_2frange_2eproto();
...
class AC_PROTO_API SignedIntRange : public ::google::protobuf::Message {
 public:
  SignedIntRange();
...
class AC_PROTO_API FloatRange : public ::google::protobuf::Message {
 public:
  FloatRange();
  virtual ~FloatRange();
