...
void AC_PROTO_API protobuf_AddDesc_embed_5ftypes_2eproto();
...
class AC_PROTO_API EmbedImage : public ::google::protobuf::Message {
 public:
  EmbedImage();
  virtual ~EmbedImage();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_embed_5ftypes_2eproto();
...
class AC_PROTO_API Provider : public ::google::protobuf::Message {
 public:
  Provider();
  virtual ~Provider();
...
class AC_PROTO_API EmbedHTML : public ::google::protobuf::Message {
 public:
  EmbedHTML();
  virtual ~EmbedHTML();
...
class AC_PROTO_API EmbedInfo : public ::google::protobuf::Message {
 public:
  EmbedInfo();
  virtual ~EmbedInfo();
