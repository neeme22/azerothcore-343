...
void AC_PROTO_API protobuf_AddDesc_rpc_5ftypes_2eproto();
...
class AC_PROTO_API NO_RESPONSE : public ::google::protobuf::Message {
 public:
  NO_RESPONSE();
  virtual ~NO_RESPONSE();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_rpc_5ftypes_2eproto();
...
class AC_PROTO_API Address : public ::google::protobuf::Message {
 public:
  Address();
  virtual ~Address();
...
class AC_PROTO_API ProcessId : public ::google::protobuf::Message {
 public:
  ProcessId();
  virtual ~ProcessId();
...
class AC_PROTO_API ObjectAddress : public ::google::protobuf::Message {
 public:
  ObjectAddress();
...
class AC_PROTO_API NoData : public ::google::protobuf::Message {
 public:
  NoData();
  virtual ~NoData();
...
class AC_PROTO_API ErrorInfo : public ::google::protobuf::Message {
 public:
  ErrorInfo();
  virtual ~ErrorInfo();
...
class AC_PROTO_API FanoutTarget : public ::google::protobuf::Message {
 public:
  FanoutTarget();
...
class AC_PROTO_API Header : public ::google::protobuf::Message {
 public:
  Header();
  virtual ~Header();
