...
void AC_PROTO_API protobuf_AddDesc_invitation_5ftypes_2eproto();
...
AC_PROTO_API bool InvitationRemovedReason_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* InvitationRemovedReason_descriptor();
...
AC_PROTO_API bool SuggestionRemovedReason_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* SuggestionRemovedReason_descriptor();
...
class AC_PROTO_API Invitation : public ::google::protobuf::Message {
 public:
  Invitation();
  virtual ~Invitation();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_invitation_5ftypes_2eproto();
...
class AC_PROTO_API InvitationParams : public ::google::protobuf::Message {
 public:
  InvitationParams();
