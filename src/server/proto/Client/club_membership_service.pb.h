...
void AC_PROTO_API protobuf_AddDesc_club_5fmembership_5fservice_2eproto();
...
class AC_PROTO_API SubscribeRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5fmembership_5fservice_2eproto();
...
class AC_PROTO_API GetStateRequest : public ::google::protobuf::Message {
 public:
  GetStateRequest();
...
class AC_PROTO_API GetStateResponse : public ::google::protobuf::Message {
 public:
  GetStateResponse();
...
class AC_PROTO_API UpdateClubSharedSettingsRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API GetStreamMentionsRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API GetStreamMentionsResponse : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RemoveStreamMentionsRequest : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ClubMembershipService : public ServiceBase
{
 public:
