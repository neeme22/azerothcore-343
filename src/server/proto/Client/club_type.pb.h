...
void AC_PROTO_API protobuf_AddDesc_club_5ftype_2eproto();
...
class AC_PROTO_API UniqueClubType : public ::google::protobuf::Message {
 public:
  UniqueClubType();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_club_5ftype_2eproto();
