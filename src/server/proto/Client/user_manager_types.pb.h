...
void AC_PROTO_API protobuf_AddDesc_user_5fmanager_5ftypes_2eproto();
...
class AC_PROTO_API RecentPlayer : public ::google::protobuf::Message {
 public:
  RecentPlayer();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_user_5fmanager_5ftypes_2eproto();
...
class AC_PROTO_API BlockedPlayer : public ::google::protobuf::Message {
 public:
  BlockedPlayer();
