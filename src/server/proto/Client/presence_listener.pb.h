...
void AC_PROTO_API protobuf_AddDesc_presence_5flistener_2eproto();
...
class AC_PROTO_API SubscribeNotification : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_presence_5flistener_2eproto();
...
class AC_PROTO_API PresenceListener : public ServiceBase
{
 public:
