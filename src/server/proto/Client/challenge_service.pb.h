...
void AC_PROTO_API protobuf_AddDesc_challenge_5fservice_2eproto();
...
class AC_PROTO_API ChallengeExternalRequest : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  ::std::string* payload_;
  friend void AC_PROTO_API protobuf_AddDesc_challenge_5fservice_2eproto();
...
class AC_PROTO_API ChallengeExternalResult : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API ChallengeListener : public ServiceBase
{
 public:
