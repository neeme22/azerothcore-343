...
void AC_PROTO_API protobuf_AddDesc_voice_5ftypes_2eproto();
...
AC_PROTO_API bool VoiceJoinType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* VoiceJoinType_descriptor();
...
AC_PROTO_API bool VoiceMuteReason_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* VoiceMuteReason_descriptor();
...
AC_PROTO_API bool VoiceProviderVersion_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* VoiceProviderVersion_descriptor();
...
class AC_PROTO_API VoiceCredentials : public ::google::protobuf::Message {
 public:
  VoiceCredentials();
 ...
 private:
  ...
  int join_type_;
  int mute_reason_;
  friend void AC_PROTO_API protobuf_AddDesc_voice_5ftypes_2eproto();
