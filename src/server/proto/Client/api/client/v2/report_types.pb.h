...
void AC_PROTO_API protobuf_AddDesc_api_2fclient_2fv2_2freport_5ftypes_2eproto();
...
AC_PROTO_API bool IssueType_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* IssueType_descriptor();
...
AC_PROTO_API bool UserSource_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* UserSource_descriptor();
...
AC_PROTO_API bool ClubSource_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* ClubSource_descriptor();
...
class AC_PROTO_API ReportItem : public ::google::protobuf::Message {
 public:
  ReportItem();
  virtual ~ReportItem();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_api_2fclient_2fv2_2freport_5ftypes_2eproto();
...
class AC_PROTO_API UserOptions : public ::google::protobuf::Message {
 public:
  UserOptions();
  virtual ~UserOptions();
...
class AC_PROTO_API ClubOptions : public ::google::protobuf::Message {
 public:
  ClubOptions();
  virtual ~ClubOptions();
...
class AC_PROTO_API EntityOptions : public ::google::protobuf::Message {
 public:
  EntityOptions();
