...
void AC_PROTO_API protobuf_AddDesc_api_2fclient_2fv2_2fattribute_5ftypes_2eproto();
...
AC_PROTO_API bool AttributeFilter_Operation_IsValid(int value);
...
AC_PROTO_API const ::google::protobuf::EnumDescriptor* AttributeFilter_Operation_descriptor();
...
class AC_PROTO_API Variant : public ::google::protobuf::Message {
 public:
  Variant();
  virtual ~Variant();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_api_2fclient_2fv2_2fattribute_5ftypes_2eproto();
...
class AC_PROTO_API Attribute : public ::google::protobuf::Message {
 public:
  Attribute();
  virtual ~Attribute();
...
class AC_PROTO_API AttributeFilter : public ::google::protobuf::Message {
 public:
  AttributeFilter();
