...
void AC_PROTO_API protobuf_AddDesc_notification_5ftypes_2eproto();
...
class AC_PROTO_API Target : public ::google::protobuf::Message {
 public:
  Target();
  virtual ~Target();
 ...
 private:
  ...
  ::std::string* type_;
  friend void AC_PROTO_API protobuf_AddDesc_notification_5ftypes_2eproto();
...
class AC_PROTO_API TargetIdentity : public ::google::protobuf::Message {
 public:
  TargetIdentity();
...
class AC_PROTO_API Subscription : public ::google::protobuf::Message {
 public:
  Subscription();
...
class AC_PROTO_API Notification : public ::google::protobuf::Message {
 public:
  Notification();
