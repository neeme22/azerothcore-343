...
void AC_PROTO_API protobuf_AddDesc_content_5fhandle_5ftypes_2eproto();
...
class AC_PROTO_API ContentHandle : public ::google::protobuf::Message {
 public:
  ContentHandle();
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_content_5fhandle_5ftypes_2eproto();
...
class AC_PROTO_API TitleIconContentHandle : public ::google::protobuf::Message {
 public:
