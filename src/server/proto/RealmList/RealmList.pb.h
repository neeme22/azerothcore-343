...
void AC_PROTO_API protobuf_AddDesc_RealmList_2eproto();
...
class AC_PROTO_API RealmListTicketIdentity : public ::google::protobuf::Message {
 public:
 ...
 private:
  ...
  friend void AC_PROTO_API protobuf_AddDesc_RealmList_2eproto();
...
class AC_PROTO_API ClientVersion : public ::google::protobuf::Message {
 public:
  ClientVersion();
...
class AC_PROTO_API ClientInformation : public ::google::protobuf::Message {
 public:
  ClientInformation();
...
class AC_PROTO_API RealmListTicketClientInformation : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RealmCharacterCountEntry : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RealmCharacterCountList : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RealmEntry : public ::google::protobuf::Message {
 public:
  RealmEntry();
  virtual ~RealmEntry();
...
class AC_PROTO_API RealmState : public ::google::protobuf::Message {
 public:
  RealmState();
  virtual ~RealmState();
...
class AC_PROTO_API RealmListUpdates : public ::google::protobuf::Message {
 public:
  RealmListUpdates();
...
class AC_PROTO_API IPAddress : public ::google::protobuf::Message {
 public:
  IPAddress();
  virtual ~IPAddress();
...
class AC_PROTO_API RealmIPAddressFamily : public ::google::protobuf::Message {
 public:
...
class AC_PROTO_API RealmListServerIPAddresses : public ::google::protobuf::Message {
 public:
