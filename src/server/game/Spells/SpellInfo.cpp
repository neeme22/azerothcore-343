...
int32 SpellInfo::CalcPowerCost(Unit const* caster, SpellSchoolMask schoolMask, Spell* spell) const
{
    ...
    // mod-spellregulator: ajuste del coste desde la tabla `spellregulator`.
    // Va aqui, al final, para que se aplique sobre el coste ya modificado por
    // talentos y auras en vez de sobre el coste base del DBC.
