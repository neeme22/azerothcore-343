...
bool LoadRealmInfo(Acore::Asio::IoContext& ioContext)
{
    ...
    // Realm de la pila de TC (bnetserver): [0] externa, [1] local
    realm.Addresses.clear();
    realm.Addresses.push_back(externalAddress->address());
    ...
    realm.Addresses.push_back(localAddress->address());
