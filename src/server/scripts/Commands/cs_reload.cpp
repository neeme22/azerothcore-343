...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        ...
        static ChatCommandTable reloadCommandTable =
        {
            ...
            { "spell_regulator",               HandleReloadSpellRegulator,                    rbac::RBAC_PERM_COMMAND_RELOAD, Console::Yes },
    ...
    {
        LOG_INFO("server.loading", "Reloading Spell Regulator...");
        sSpellRegulator->LoadFromDB();
        handler->SendGlobalGMSysMessage("DB tables `spellregulator` and `npc_spell_amplification` reloaded.");
        return true;
    }
