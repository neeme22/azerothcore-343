...
public:
    ...
    static value_type GetValue(UF::ObjectData const* objectData, Object const* object, Player const* receiver)
    {
        ...
        // worldgate: objetos fuera de mapa = copias de la pasarela; AzerothCore ya filtró el valor para este jugador
        if (!object->IsInWorld()) return dynamicFlags;
        if (Unit const* unit = object->ToUnit())
        {
...
public:
    ...
    static value_type GetValue(UF::UnitData const* unitData, Unit const* unit, Player const* receiver)
    {
        ...
        // worldgate: objetos fuera de mapa = copias de la pasarela; AzerothCore ya filtró el valor para este jugador
        if (!unit->IsInWorld()) return displayId;
        if (unit->IsCreature())
        {
...
public:
    ...
    static value_type GetValue(UF::UnitData const* unitData, Unit const* unit, Player const* receiver)
    {
        ...
        // worldgate: objetos fuera de mapa = copias de la pasarela; AzerothCore ya filtró el valor para este jugador
        if (!unit->IsInWorld()) return flags;
...
public:
    ...
    static value_type GetValue(UF::UnitData const* unitData, Unit const* unit, Player const* receiver)
    {
        ...
        if (!unit->IsInWorld()) return unitData->AuraState;   // worldgate: objetos fuera de mapa = copias de la pasarela; AzerothCore ya filtró el valor para este jugador
...
public:
    ...
    static value_type GetValue(UF::UnitData const* unitData, uint32 i, Unit const* unit, Player const* receiver)
    {
        ...
        // worldgate: objetos fuera de mapa = copias de la pasarela; AzerothCore ya filtró el valor para este jugador
        if (!unit->IsInWorld()) return npcFlag;
...
public:
    ...
    static value_type GetValue(UF::GameObjectData const* gameObjectData, GameObject const* gameObject, Player const* receiver)
    {
        ...
        // worldgate: objetos fuera de mapa = copias de la pasarela; AzerothCore ya filtró el valor para este jugador
        if (!gameObject->IsInWorld()) return flags;
...
public:
    ...
    static value_type GetValue(UF::GameObjectData const* gameObjectData, GameObject const* gameObject, Player const* receiver)
    {
        if (!gameObject->IsInWorld()) return gameObjectData->State;
