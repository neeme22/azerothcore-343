...
namespace WorldPackets
{
    namespace Inspect
    {
        ...
        struct PVPBracketData
        {
            ...
            int32 UnknownRating = 0;   // Wrathion (3.4.3.54261)
            int32 Unused4 = 0;
            int32 Unused5 = 0;
            int32 Unused6 = 0;
            uint8 Bracket = 0;
        ...
        struct InspectTalentData                // Wrathion (3.4.3.54261): talento y rango
        {
            uint32 Id = 0;
            uint8 Rank = 0;
        };
        ...
        public:
            ...
            std::array<InspectTalentData, 71> TalentRanks = { };   // lo que escribe el 3.4.3
