...
namespace WorldPackets
{
    namespace Battleground
    {
        ...
        struct PVPMatchStatistics
        {
            ...
            Optional<uint8> Winner;             // Wrathion (3.4.3.54261)
        ...
        public:
            ...
            Array<uint64, 1> QueueIDs;          // TC; Read() lo rellena con PackedBattlegroundQueueTypeID
            uint8 Roles = 0;
            int32 BlacklistMap[2] = { };
            uint64 PackedBattlegroundQueueTypeID = 0;   // formato 3.4.3 (Wrathion)
        ...
        public:
            ...
            uint8 TeamSizeIndex = 0;            // TC; Read() lo copia de TeamSlot
            uint8 Roles = 0;
            ObjectGuid BattlemasterGuid;        // formato 3.4.3 (Wrathion)
            uint8 TeamSlot = 0;
        };
        ...
        public:
            ...
            ObjectGuid BattlemasterGuid;
            int32 Verification = 0;             // Wrathion (3.4.3.54261)
        ...
        class BattlemasterJoinSkirmishArena final : public ClientPacket
        {
        public:
            BattlemasterJoinSkirmishArena(WorldPacket&& packet) : ClientPacket(CMSG_BATTLEMASTER_JOIN_SKIRMISH, std::move(packet)) { }
