-- Base de login de TrinityCore 3.4.3 que usa la pasarela worldgate para los permisos (RBAC) de su Player/WorldSession.
-- Estructura de todas las tablas + datos de rbac_* (los de TrinityCore TDB343.24081). Sin cuentas.
-- CREATE DATABASE tc343_auth DEFAULT CHARSET utf8mb4;  y luego:  mysql tc343_auth < tc343_auth.sql
