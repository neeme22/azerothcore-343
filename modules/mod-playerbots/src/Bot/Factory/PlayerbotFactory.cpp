...
void PlayerbotFactory::InitClassSpells()
{
    ...
    switch (bot->getClass())
    {
        ...
        case CLASS_DEATH_KNIGHT:
            ...
            // bot->learnSpell(48778, false); // Acherus Deathcharger (class mount) disabled:
            // re-randomized bots kept it on other classes (e.g. Hunters). Bots use racial mounts instead.
            break;
        case CLASS_HUNTER:
